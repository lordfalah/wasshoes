...
import {
  TUpdateCartItemSchema,
  updateCartItemSchema,
} from "@/schemas/cart.schema";
import { addToCart } from "@/actions/cart";

interface AddToCheckoutFormProps {
  productId: string;
  showBuyNow?: boolean;
}

const AddToCartForm: React.FC<AddToCheckoutFormProps> = ({
  productId,
  showBuyNow,
}) => {
  ...
  const form = useForm<TUpdateCartItemSchema>({
  ...
  async function onSubmit(data: TUpdateCartItemSchema) {
