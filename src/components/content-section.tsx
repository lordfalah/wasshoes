    ...
    <section className={cn("space-y-6", className)} {...props}>
      <div className="flex items-center justify-between gap-4">
        <div className="flex max-w-[61.25rem] flex-1 flex-col gap-0.5">
          <h2 className="text-2xl leading-[1.1] font-bold md:text-3xl">
            {title}
          </h2>
          {description ? (
            <p className="text-muted-foreground max-w-[46.875rem] text-sm leading-normal text-balance sm:text-base sm:leading-7">
              {description}
            </p>
          ) : null}
        </div>
